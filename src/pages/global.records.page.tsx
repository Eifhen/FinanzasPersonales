...
import GlobalRecordCardList from '../components/global.cardList.component';
    ...
    return(
        <main className='f-roboto fade-in bg-pure h-min-100vh align-column-between'>
            ...
            <section className='container h-min-100vh align-self-center bg-pure mb-4'>
                ...
                <GlobalRecordCardList path={path} globalReport={ report } records={ records } action={context.openModal} />
            </section>
